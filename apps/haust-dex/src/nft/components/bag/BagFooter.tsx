...
export const BagFooter = ({ setModalIsOpen }: BagFooterProps) => {
  ...
  const usingPayWithAnyToken = !!inputCurrency && shouldUsePayWithAnyToken && chainId === SupportedChainId.HAUST
  ...
  const sufficientBalance = useMemo(() => {
    if (!connected || chainId !== SupportedChainId.HAUST) {
      return undefined
    }
  ...
  const {
    ...
    if (connected && chainId !== SupportedChainId.HAUST_TESTNET) {
      handleClick = () => switchChain(connector, SupportedChainId.HAUST_TESTNET)
