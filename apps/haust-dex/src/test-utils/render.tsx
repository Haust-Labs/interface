...
import { Queries, render, renderHook, RenderResult } from '@testing-library/react'
...
const customRender = (ui: ReactElement): RenderResult<Queries, HTMLElement, HTMLElement> =>
  render(ui, { wrapper: WithProviders })
