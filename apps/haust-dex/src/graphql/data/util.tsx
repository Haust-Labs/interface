...
export const CHAIN_ID_TO_BACKEND_NAME: { [key: number]: Chain } = {
  [SupportedChainId.HAUST]: Chain.HAUST,
  [SupportedChainId.HAUST_TESTNET]: Chain.BSCTestnet,
}
...
const GQL_CHAINS: number[] = [SupportedChainId.HAUST, SupportedChainId.HAUST_TESTNET]
...
const URL_CHAIN_PARAM_TO_BACKEND: { [key: string]: Chain } = {
  ...
  bsc_mainnet: Chain.HAUST,
  HAUST_TESTNET: Chain.BSCTestnet,
  moonbase_alpha: Chain.MoonbaseAlpha,
}
...
export const CHAIN_NAME_TO_CHAIN_ID: { [key in Chain]: SupportedChainId } = {
  ...
  [Chain.BSCTestnet]: SupportedChainId.HAUST_TESTNET,
}
...
export const BACKEND_CHAIN_NAMES: Chain[] = [Chain.Ethereum, Chain.Polygon, Chain.Optimism, Chain.Arbitrum, Chain.Celo, Chain.BSCTestnet]
