  ...
  describe('useCallsDataSubscription', () => {
    ...
    describe('stabilizes values', () => {
      ...
      it('ignores subsequent updates if data is stable', () => {
        ...
        const MockCaller: typeof Caller = jest.fn(Caller)
        ...
        const mockContext = {
          ...
          actions: {
            addMulticallListeners: jest
              .fn()
              .mockImplementation((arg: NonNullable<unknown>) => ({ type: 'multicall/addMulticallListeners', payload: arg })),
            removeMulticallListeners: jest
              .fn()
              .mockImplementation((arg: NonNullable<unknown>) => ({ type: 'multicall/removeMulticallListeners', payload: arg })),
          },
        }
