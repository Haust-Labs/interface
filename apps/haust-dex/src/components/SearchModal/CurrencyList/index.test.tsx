...
const mockCurrencyAmt = {
  // [DAI_MOONBEAM.address]: mockCurrencyAmount.fromRawAmount(DAI_MOONBEAM, mockJSBI.default.BigInt(100)),
  // [USDC_MOONBEAM.address]: mockCurrencyAmount.fromRawAmount(USDC_MOONBEAM, mockJSBI.default.BigInt(10)),
  // [WBTC_MOONBEAM.address]: mockCurrencyAmount.fromRawAmount(WBTC_MOONBEAM, mockJSBI.default.BigInt(1)),
}
...
//     <CurrencyList
//       height={10}
//       currencies={[DAI_MOONBEAM, USDC_MOONBEAM, WBTC_MOONBEAM]}
//       otherListTokens={[]}
//       selectedCurrency={null}
//       onCurrencySelect={noOp}
//       isLoading={false}
